  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <div className="text-center">
        ...
        <h1 className="mt-1 font-serif text-4xl font-bold text-[#1e4d5c]">
      ...
      <div className="mt-8 space-y-4">
        {ARTICLES.map((article) => (
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-wide text-[#c2703e]">
              {CATEGORY_LABELS[article.category]}
            </p>
            <h2 className="mt-1 font-serif text-xl font-bold leading-snug text-[#1e4d5c]">
              {article.title}
            </h2>
            ...
            <p className="mt-3 flex items-center gap-3 text-sm">
              ...
              <span className="inline-flex items-center gap-1 font-medium text-[#2e7d8c]">
